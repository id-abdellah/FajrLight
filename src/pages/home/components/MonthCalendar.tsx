    ...
    return (
        <div className="bg-surface py-3">
            <div className="flex gap-3 justify-center text-md">
                <span>{readableDate(prayerTimesData.gregorianDate, prayerTimesData.weekDay, "gregorian")}</span>
                <span className="italic">الموافق</span>
                <span>{readableDate(prayerTimesData.hijriDate, prayerTimesData.weekDay, "hijri")}</span>
            </div>
            {/* <div>
