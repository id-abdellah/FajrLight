import { faPause, faPlay, faTriangleExclamation } from "@fortawesome/free-solid-svg-icons";
...
export default function SurahAudio({ audioURL }: Props) {
    ...
    return (
        <button className="bg-secondary hover:bg-hover_secondary" onClick={() => toggleAudio()}>
            {
                audioStatus == "play"
                    ?
